...
\equiv{ \ensuremath{\conj{\conj{\Varid{h}}{\Varid{g}}}{\Varid{f}}} = \ensuremath{\llparenthesis\, \conj{\conj{[\mskip1.5mu \Varid{j1},\Varid{j2}\mskip1.5mu]}{[\mskip1.5mu \Varid{k1},\Varid{k2}\mskip1.5mu]}}{[\mskip1.5mu \Varid{l1},l_2 \mskip1.5mu]}\,\rrparenthesis}}

O que por fim nos leva a 

%
        \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{h}\;\mathrm{0}\mathrel{=}\Varid{a}\\\Varid{h}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{j2}\;((\Varid{h}\;\Varid{n},\Varid{g}\;\Varid{n}),\Varid{f}\;\Varid{n})\end{lcbr}\\\begin{lcbr}\Varid{g}\;\mathrm{0}\mathrel{=}\Varid{b}\\\Varid{g}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{k2}\;((\Varid{h}\;\Varid{n},\Varid{g}\;\Varid{n}),\Varid{f}\;\Varid{n})\end{lcbr}\\\begin{lcbr}\Varid{f}\;\mathrm{0}\mathrel{=}\Varid{c}\\\Varid{f}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}l_2 \;((\Varid{h}\;\Varid{n},\Varid{g}\;\Varid{n}),\Varid{f}\;\Varid{n})\end{lcbr}\end{lcbr}}
%


\equiv{ \ensuremath{\conj{\conj{\Varid{h}}{\Varid{g}}}{\Varid{f}}} = \ensuremath{\llparenthesis\, \conj{\conj{[\mskip1.5mu \underline{\Varid{a}},\Varid{j2}\mskip1.5mu]}{[\mskip1.5mu \underline{\Varid{b}},\Varid{k2}\mskip1.5mu]}}{[\mskip1.5mu \underline{\Varid{c}},l_2 \mskip1.5mu]}\,\rrparenthesis}}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathrel{=}{}\<[14]%
\>[14]{}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1}){}\<[18]%
\>[18]{}\mathrel{=}{}\<[18E]%
\>[21]{}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{2}){}\<[38]%
\>[38]{}\mathrel{=}{}\<[38E]%
\>[41]{}\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}{}\<[12]%
\>[12]{}\mathrel{=}{}\<[12E]%
\>[15]{}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1}){}\<[18]%
\>[18]{}\mathrel{=}{}\<[18E]%
\>[21]{}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{3}){}\<[38]%
\>[38]{}\mathrel{=}{}\<[38E]%
\>[41]{}\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathbin{+}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathbin{+}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{a}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{h2}\mathrel{=}\Varid{aux}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{b}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{k2}\mathrel{=}\p1\comp \p1{}\<[E]%
\\
\>[B]{}\Varid{c}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}l_2 \mathrel{=}\p2\comp \p1{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{aux}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;((\Varid{h},\Varid{g}),\Varid{f})\mathrel{=}\Varid{a}\mathbin{*}\Varid{h}\mathbin{+}\Varid{b}\mathbin{*}\Varid{g}\mathbin{+}\Varid{c}\mathbin{*}\Varid{f}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\ensuremath{\conj{\conj{\Varid{h}}{\Varid{g}}}{\Varid{f}}} = \ensuremath{\for{\conj{\conj{\Varid{aux}}{\p1\comp \p1}}{\p2\comp \p1}}\ {(\mathrm{1},\mathrm{1}),\mathrm{0}}}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}\mathrel{=}\conj{\conj{\Varid{aux}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\p1\comp \p1}}{\p2\comp \p1}{}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{gene}\mathrel{=}\Varid{auxi}\comp \Varid{out}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxi}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxi}\mathbin{::}\Conid{String}+(\Conid{String},[\mskip1.5mu \Conid{String}\mskip1.5mu])\to \Conid{String}+(\Conid{String},[\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{auxi}\;(i_1\;\Varid{x})\mathrel{=}i_1\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{auxi}\;(i_2\;(\Varid{a},\Varid{l}))\mathrel{=}i_2\;(\Varid{a},(\Varid{groupBy}\;(\lambda \Varid{x}\;\Varid{lista}\to \Varid{head}\;(\Varid{lista})\equiv \text{\ttfamily '~'})\;(\map \;(\Varid{drop}\;\mathrm{4})\;\Varid{l}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{post}\;(\Conid{Var}\;\Varid{x})\mathrel{=}[\mskip1.5mu [\mskip1.5mu \Varid{x}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{post}\;(\Conid{Term}\;\Varid{y}\;\Varid{z})\mathrel{=}\Varid{ajuntamento}\;[\mskip1.5mu [\mskip1.5mu \Varid{y}\mskip1.5mu]\mskip1.5mu]\;(\Varid{concatMap}\;(\lambda \Varid{n}\to \map \;(\Varid{y}\mathbin{:})\;(\Varid{post}\;\Varid{n}))\;\Varid{z}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{ajuntamento}\mathbin{::}[\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{ajuntamento}\;\Varid{x}\;\Varid{y}\mathrel{=}\Varid{x}\mathbin{<>}\Varid{y}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{parteQuadrado}\;(((\Varid{x},\Varid{y}),\Varid{lar}),\mathrm{0})\mathrel{=}(((\Varid{x}\mathbin{+}\Varid{lar}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{lar}\mathbin{/}\mathrm{3}),[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{parteQuadrado}\;(((\Varid{x},\Varid{y}),\Varid{lar}),\Varid{n})\mathrel{=}(((\Varid{x}\mathbin{+}\Varid{lar}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{lar}\mathbin{/}\mathrm{3}),[\mskip1.5mu {}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}(((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{lar}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}(((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{lar}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}(((\Varid{x}\mathbin{+}\Varid{lar}\mathbin{/}\mathrm{3},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}(((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{lar}\mathbin{/}\mathrm{3},\Varid{y}),\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}(((\Varid{x},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}(((\Varid{x}\mathbin{+}\Varid{lar}\mathbin{/}\mathrm{3},\Varid{y}),\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}(((\Varid{x},\Varid{y}\mathbin{+}\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}(((\Varid{x},\Varid{y}),\Varid{lar}\mathbin{/}\mathrm{3}),\Varid{n}\mathbin{-}\mathrm{1})\mskip1.5mu]){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gsq}{}\<[6]%
\>[6]{}\mathrel{=}\Varid{parteQuadrado}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{geraQuadrado}\;\Varid{n}\mathrel{=}(\Varid{sierpinski}\;(\Varid{base},\Varid{n}){}\<[41]%
\>[41]{},\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{base}\mathrel{=}((\mathrm{0},\mathrm{0}),\mathrm{32}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{carpets}\mathrel{=}\anaList{(\Varid{id}+\Varid{geraQuadrado}){}\<[44]%
\>[44]{}\comp \Varid{outNat}}{}\<[E]%
\\[\blanklineskip]%
